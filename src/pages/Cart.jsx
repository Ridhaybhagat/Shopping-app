  ...
  return (<div className="flex flex-col items-center">
    {
      ...
      ( <div className="grid xs:grid-cols-1 sm:grid-cols-2 gap-10 p-5">
        ...
        <Link to={"/"}>
        <button className="bg-green-600 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 
        border-2 border-green-600 font-semibold hover:text-green-700 p-3 px-10 tracking-wider">
          Shop Now
        </button>
        </Link>
      </div>
